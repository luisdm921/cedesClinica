        ...
        <div className="overflow-hidden rounded-3xl bg-white shadow-xl md:flex">
          ...
          <div className="flex flex-col justify-center p-10 md:flex-1 md:p-14">
            ...
            <a
              ...
              className="inline-flex w-fit items-center gap-2.5 rounded-full bg-petroleum px-8 py-3.5 text-base font-bold text-white shadow-lg transition-all hover:-translate-y-0.5 hover:bg-petroleum-light"
            >
          ...
          {/* Lado derecho — Visual */}
          <div className="relative min-h-[300px] md:flex-1">
            <Image
              src="/images/Relax/CedexRelax.jpeg"
